...
public class admin_panel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Service Details");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "customer_id", "customer_name", "password", "age", "email", "address(district)"
            }
        ));
        ...
        table3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "expenditure_id", "customer_id", "customer_name", "service_id", "service_name", "cost_perUnit", "quantity", "total_cost", "Date", "Time", "Month"
            }
        ));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'February'");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'January'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'March'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'April'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'May'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'June'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'July'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'August'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'September'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'October'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'November'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        // TODO add your handling code here:
         ...
         Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/csms","root","");
        Statement stmt = conn.createStatement();
        ResultSet rs = stmt.executeQuery(" select * from expenditure where strMonth = 'December'");
        table3.setModel(DbUtils.resultSetToTableModel(rs));
        conn.close();
